    ...
    public class Functions
    {
        ...
        public async System.Threading.Tasks.Task GenarateXmlAsync(vMeter source,List<FileXMLPath> pathFile , DataConnection.SIGE.Task task)
        {
            try
            {
                ...
                foreach (Job jb in jobs)
                {
                    ...
                    SqlParameter p2 = new SqlParameter("@DataI", jb.dDataStartTime.Value.AddMinutes(5).AddHours(3).ToString("yyyy-MM-dd HH:mm"));
                    SqlParameter p3 = new SqlParameter("@DataF", jb.dDataEndTime.Value.AddHours(3).ToString("yyyy-MM-dd HH:mm"));
                    ...
                    if (dataLogs.Count != 0)
                    {
                        ...
                        foreach (var d in dataLogs)
                        {
                            ...
                            //xmlObject.SetLeituraEnergia(d.TimestampUtc.AddHours(-3), (Convert.ToDecimal(d.kWh_Forn) == null? 0: Convert.ToDecimal(d.kWh_Forn)),( Convert.ToDecimal(d.kWh_Rec) == null? 0: Convert.ToDecimal(d.kWh_Rec)), (Convert.ToDecimal(d.kVARh_Forn) == null ? 0: Convert.ToDecimal(d.kVARh_Forn)), (Convert.ToDecimal(d.kVARh_Rec) == null ? 0: Convert.ToDecimal(d.kVARh_Rec)));
                            xmlObject.SetLeituraEnergia(d.TimestampUtc.AddHours(-3), (Convert.ToDecimal(d.kWh_Rec) == null ? 0 : Convert.ToDecimal(d.kWh_Rec)), (Convert.ToDecimal(d.kWh_Forn) == null ? 0 : Convert.ToDecimal(d.kWh_Forn)), (Convert.ToDecimal(d.kVARh_Rec) == null ? 0 : Convert.ToDecimal(d.kVARh_Rec)), (Convert.ToDecimal(d.kVARh_Forn) == null ? 0 : Convert.ToDecimal(d.kVARh_Forn)));
                            xmlObject.SetLeituraEng(d.TimestampUtc.AddHours(-3), (Convert.ToDecimal(d.Vln_a_mean) == null?0: Convert.ToDecimal(d.Vln_a_mean)), (Convert.ToDecimal(d.Vln_b_mean) == null ?0: Convert.ToDecimal(d.Vln_b_mean)), (Convert.ToDecimal(d.Vln_c_mean) == null? 0: Convert.ToDecimal(d.Vln_c_mean)), (Convert.ToDecimal(d.Ia_mean) == null ?0: Convert.ToDecimal(d.Ia_mean)), (Convert.ToDecimal(d.Ib_mean) == null?0: Convert.ToDecimal(d.Ib_mean)),( Convert.ToDecimal(d.Ic_mean) == null ?0 : Convert.ToDecimal(d.Ic_mean)));
                            //if (comp != false)
                            //{
                            //xmlObject.SetLeituraCompPerda(d.TimestampUtc.AddHours(-3), (Convert.ToDecimal(d.kWh_FornCP) == null ? 0 : Convert.ToDecimal(d.kWh_FornCP)),(Convert.ToDecimal(d.kWh_RecCP) == null ? 0 : Convert.ToDecimal(d.kWh_RecCP)), (Convert.ToDecimal(d.kVARh_FornCP) == null ? 0 : Convert.ToDecimal(d.kVARh_FornCP)), (Convert.ToDecimal(d.kVARh_RecCP) == null ? 0 : Convert.ToDecimal(d.kVARh_RecCP)));
                            //}
                            xmlObject.SetLeituraCompPerda(d.TimestampUtc.AddHours(-3), (Convert.ToDecimal(d.kWh_RecCP) == null ? 0 : Convert.ToDecimal(d.kWh_RecCP)), (Convert.ToDecimal(d.kWh_FornCP) == null ? 0 : Convert.ToDecimal(d.kWh_FornCP)), (Convert.ToDecimal(d.kVARh_RecCP) == null ? 0 : Convert.ToDecimal(d.kVARh_RecCP)), (Convert.ToDecimal(d.kVARh_FornCP) == null ? 0 : Convert.ToDecimal(d.kVARh_FornCP)));
                            //}
                        }
                        ...
                        { 
                            if(jbs.bZeroData != true)
                            {
                                ...
                                else if (meter.dLastSuccessXML == null)
                                {
                                    meter.dLastSuccessXML = dataLogs.Last().TimestampUtc.Date;
                                }
                        ...
                        else
                        {
                            ...
                            SqlParameter ps2 = new SqlParameter("@DataI", j.dDataStartTime.Value.AddMinutes(5).AddHours(3).ToString("yyyy-MM-dd HH:mm"));
                            SqlParameter ps3 = new SqlParameter("@DataF", j.dDataEndTime.Value.AddHours(3).ToString("yyyy-MM-dd HH:mm"));
                            ...
                            int i = 0;
                            List<DataFault> datafaultN = dataFault.Where(n => n.NReg != 12).ToList();
                            string horaF = "Horas Faltantes(Lacunas): ";
                            foreach (DataFault d in datafaultN)
                            {
                                //if (d.Hora != i)
                                //{
                                ...
                                //if (d.NReg != 12)
                                //{
                                    horaF += Convert.ToString(d.DataHora.AddHours(-3).Hour) + ", ";
                                //}
                                //i++;
                            }
        ...
        public async System.Threading.Tasks.Task StatusTask(DataConnection.SIGE.Task task)
        {
            ...
            try
            {
                ...
                List<Job> jobTask = job.Where(t => t.iTaskID == taskID && t.bActive == true).ToList();
                if( jobTask.Count != 0)
                {
